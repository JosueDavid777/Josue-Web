...
function abrirModal(id) {
  ...
  if (d.mediaType === 'videos') {
    ...
    const defaultsMap = {
      ...
      'cargador-radio':  { b: [{ src:'https://github.com/JosueDavid777/Reparaciones-de-equipos-electr-nicos./blob/main/REPARACIONES_ELECTRONICAS/2026%20-%2005%20-ADAPTACION_RADIO/ANTES/01_RADIO_CON_CARGADOR_PARA_ADAPTAR.jpg', title: 'Radio antes de la adaptación' }, { src: null, title: 'Circuito interno analizado' }],    a: [{ src: null, title: 'Adaptación completada' }, { src: null, title: 'Radio con alimentación permanente' }] },
